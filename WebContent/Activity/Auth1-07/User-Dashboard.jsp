...
<body>
    <!-- Gavini Pahansa Gavini Pahansa Gavini Pahansa Gavini Pahansa Gavini Pahansa -->
    ...
    <div class="section" style="padding: 4%;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4" aria-disabled="true">
                                ...
                                <button class="btn btn-outline-success btn-block" type="button"
                                    onclick="tchangeUser()"><i class="fa fa-shield" aria-hidden="true"></i> Request to
            ...
            <div class="col-md-12">
                <div class="card border-dark">
                    <div class="card-header bg-dark" style="color: #fff;">
                        <div class="row">
                            <div class="col"><i class="fa fa-calendar" aria-hidden="true"></i> WEEK NO: 47</div>
                            ...
                            <div class="col">
                                <div class="card text-white mb-3">
                                    ...
                                    <div class="card-body bg-dark">
                                        ...
                                        <hr>
                                        <button type="button" onclick="worksheet1()"
                                            class="btn btn-outline-success btn-block"><i class="fa fa-cloud-download"
                                                aria-hidden="true"></i>
                                            Download</button>
                                    </div>
                                </div>
                            ...
                            <div class="col">
                                <div class="card text-white mb-3">
                                    ...
                                    <div class="card-body bg-dark">
                                        ...
                                        <i class="fa fa-file-pdf-o" aria-hidden="true" style="font-size: 50px;"></i>
                                        <hr>
                                        <button type="button" onclick="worksheet2()"
                                            class="btn btn-outline-success btn-block"><i class="fa fa-cloud-download"
                                                aria-hidden="true"></i>
                                            Download</button>
                                    </div>
                            ...
                            <div class="col">
                                <div class="card text-white mb-3">
                                    ...
                                    <div class="card-body bg-dark">
                                        ...
                                        <i class="fa fa-file-pdf-o" aria-hidden="true" style="font-size: 50px;"></i>
                                        <hr>
                                        <button type="button" onclick="worksheet3()"
                                            class="btn btn-outline-success btn-block"><i class="fa fa-cloud-download"
                                                aria-hidden="true"></i>
                                            Download</button>
                                    </div>
                            ...
                            <div class="col">
                                <div class="card text-white mb-3">
                                    ...
                                    <div class="card-body bg-dark">
                                        ...
                                        <i class="fa fa-file-pdf-o" aria-hidden="true" style="font-size: 50px;"></i>
                                        <hr>
                                        <button type="button" onclick="worksheet4()"
                                            class="btn btn-outline-success btn-block"><i class="fa fa-cloud-download"
                                                aria-hidden="true"></i>
                                            Download</button>
                                    </div>
                            ...
                            <div class="col">
                                <div class="card text-white mb-3">
                                    ...
                                    <div class="card-body bg-dark">
                                        ...
                                        <i class="fa fa-file-pdf-o" aria-hidden="true" style="font-size: 50px;"></i>
                                        <hr>
                                        <button type="button" onclick="worksheet5()"
                                            class="btn btn-outline-success btn-block"><i class="fa fa-cloud-download"
                                                aria-hidden="true"></i>
                                            Download</button>
                                    </div>
        ...
        <!-- <div class="row">
            <div class="col-md-12">
                <div class="card border-dark">
                    <div class="card-header bg-dark" style="color: #fff;">
                        මවට උපදෙස් - Day: Monday
                    </div>
                    <div class="card-body">
                        <h5 class="card-title">කොහොමද මේ activity 01 එක කරන්නෙ?</h5>
                        <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                        <button type="button" class="btn btn-success" onclick="tcall()">Call Teacher</button>
                    </div>
                    <hr>
                    <div class="card-body">
                        <h5 class="card-title">කොහොමද මේ activity 02 එක කරන්නෙ?</h5>
                        <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                        <button type="button" class="btn btn-success" onclick="tcall()">Call Teacher</button>
                    </div>
                    <hr>
                    <div class="card-body">
                        <h5 class="card-title">කොහොමද මේ activity 03 එක කරන්නෙ?</h5>
                        <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                        <button type="button" class="btn btn-success" onclick="tcall()">Call Teacher</button>
                    </div>
                    <hr>
                    <div class="card-body">
                        <h5 class="card-title">කොහොමද මේ activity 04 එක කරන්නෙ?</h5>
                        <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                        <button type="button" class="btn btn-success" onclick="tcall()">Call Teacher</button>
                    </div>
                    <hr>
                    <div class="card-body">
                        <h5 class="card-title">කොහොමද මේ activity 05 එක කරන්නෙ?</h5>
                        <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                        <button type="button" class="btn btn-success" onclick="tcall()">Call Teacher</button>
                    </div>
                </div>
...
<script>
    ...
    function worksheet1() {
        ...
        window.open("../../pages/Tutorial/4-5-Years/Week_50/activity_01.pdf");
    }
    function worksheet2() {
        console.log("Worksheet 2 Downloading...");
        window.open("../../pages/Tutorial/4-5-Years/Week_50/activity_02.pdf");
    }
    function worksheet3() {
        console.log("Worksheet 3 Downloading...");
        window.open("../../pages/Tutorial/4-5-Years/Week_50/activity_03.pdf");
    }
    function worksheet4() {
        console.log("Worksheet 4 Downloading...");
        window.open("../../pages/Tutorial/4-5-Years/Week_50/activity_04.pdf");
    }
    function worksheet5() {
        console.log("Worksheet 5 Downloading...");
        window.open("../../pages/Tutorial/4-5-Years/Week_50/activity_05.pdf");
    }
</script>
