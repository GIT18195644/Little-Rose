...
<body data-spy="scroll" data-target=".fixed-top">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="text-container">
                            <h1><span class="turquoise">Little Rose</span><br>Register Now</h1>
                            <p class="p-large">2021 Intake | Online Registration now available</p>
                            <a class="btn-solid-lg page-scroll" href="#Register">Register Now!</a>
    ...
    <div id="Register" class="cards-1">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <iframe id="desktopForm"
                        src="https://docs.google.com/forms/d/e/1FAIpQLSdLsutpinYFSXIpRTjiCzoIdz-nCu3ifgKpZUAYJ8-hWIhAsw/viewform?embedded=true"
                        width="640" height="1469" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>

                    <iframe id="MobileForm"
                        src="https://docs.google.com/forms/d/e/1FAIpQLSdLsutpinYFSXIpRTjiCzoIdz-nCu3ifgKpZUAYJ8-hWIhAsw/viewform?embedded=true"
                        width="375" height="825" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
                </div>
            </div>
            <img src="./images/Banner_img.jpg" width="100%" height="auto">
        </div>
    </div>
